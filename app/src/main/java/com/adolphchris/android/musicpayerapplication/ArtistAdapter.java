...
public class ArtistAdapter extends ArrayAdapter <MusicTemp>{
    public ArtistAdapter(Context context, ArrayList<MusicTemp> users) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.activity_genre_and_artist_template, parent, false);
        }
